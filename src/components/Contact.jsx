...
export default function ContactForm() {
  ...
  const testimonials = [
    {
      id: 1,
      text: "The breadth of knowledge and understanding that ELEKS has within its walls allows us to leverage that expertise to make superior deliverables for our customers. When you work with ELEKS, you are working with the top 1% of the aptitude and engineering excellence of the whole country.",
      name: "Sam Fleming",
      title: "President, Fleming-AOD",
      phone: "+1 (555) 123-4567",
      email: "sam.fleming@flemingaod.com",
      address: "123 Business Ave, New York, NY 10001",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop"
    },
    {
      id: 2,
      text: "Working with ELEKS has been a transformative experience. Their technical expertise and commitment to quality have exceeded our expectations. The team's ability to understand complex requirements and deliver innovative solutions is truly impressive.",
      name: "Maria Rodriguez",
      title: "CTO, TechVision Inc",
      phone: "+1 (555) 987-6543",
      email: "maria.rodriguez@techvision.com",
      address: "456 Tech Plaza, San Francisco, CA 94102",
      image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop"
    },
    {
      id: 3,
      text: "ELEKS has proven to be an invaluable partner in our digital transformation journey. Their proactive approach and deep industry knowledge have helped us stay ahead of the competition. I highly recommend their services to any organization seeking excellence.",
      name: "David Chen",
      title: "CEO, InnovateCorp",
      phone: "+1 (555) 246-8135",
      email: "david.chen@innovatecorp.com",
        ...
        <div className="rounded-lg p-8 lg:p-12 flex flex-col justify-between border border-stone-50/30 bg-white/10 backdrop-blur-md shadow-lg shadow-white/10">
          ...
          <div className="space-y-3 mb-8 text-sm">
            <div className="flex items-center gap-3 text-gray-300">
              ...
              <span>{currentTestimonial.phone}</span>
            </div>
            <div className="flex items-center gap-3 text-gray-300">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span>{currentTestimonial.email}</span>
            </div>
            <div className="flex items-center gap-3 ttext-gray-300">
              ...
              <span>{currentTestimonial.address}</span>
            </div>
          </div>
